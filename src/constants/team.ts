...
export const teamData: TeamMember[] = [
  ...
  },
  {
    id: '8',
    name: 'David Park',
    profession: 'Acupuncture Specialist & Traditional Chinese Medicine Practitioner',
    ...
    type: 'instructor',
    classes: ['Acupuncture Session', 'Traditional Chinese Medicine Consultation'],
    specialties: [
      'Acupuncture',
    ...
    education: 'Licensed Acupuncturist, Traditional Chinese Medicine Doctor Degree',
    contact: {
  ...
  },
  {
    ...
    type: 'instructor',
    classes: ['Nutrition Consultation', 'Healthy Cooking Workshop', 'Gut Health Seminar'],
    specialties: ['Holistic Nutrition', 'Plant-Based Diets', 'Gut Health', 'Lifestyle Coaching'],
  ...
  },
  {
    ...
    type: 'instructor',
    classes: ['Tai Chi for Beginners', 'Qigong Energy Practice', 'Advanced Tai Chi Forms'],
    specialties: ['Tai Chi', 'Qigong', 'Energy Arts', 'Movement Therapy'],
    experience: '20+ years in Tai Chi and Qigong instruction',
    education: 'Tai Chi Master Certification, Qigong Instructor Training, Energy Arts Specialist',
    contact: {
  ...
  },
  {
    ...
    type: 'instructor',
    classes: ['Sound Healing Session', 'Crystal Bowl Meditation', 'Vibrational Therapy'],
    specialties: ['Sound Healing', 'Music Therapy', 'Crystal Bowls', 'Vibrational Medicine'],
    experience: '8+ years in sound healing and music therapy',
    education: 'Certified Sound Healer, Music Therapy Certification, Crystal Bowl Training',
    contact: {
  ...
  },
  {
    ...
    type: 'instructor',
    classes: ['Aromatherapy Session', 'Essential Oil Workshop', 'Aromatherapy Massage'],
    specialties: ['Aromatherapy', 'Essential Oils', 'Natural Healing', 'Sensory Therapy'],
  ...
  },
  {
    ...
    credentials: 'Certified Breathwork Facilitator, Respiratory Therapy License',
    ...
    type: 'instructor',
    classes: ['Breathwork Session', 'Conscious Breathing Workshop', 'Respiratory Health'],
    specialties: ['Breathwork', 'Respiratory Therapy', 'Conscious Breathing', 'Energy Activation'],
    experience: '15+ years in respiratory therapy, 8+ years in breathwork facilitation',
    education:
  ...
  },
  {
    ...
    credentials: 'Wellness Management Degree, Customer Experience Certification',
