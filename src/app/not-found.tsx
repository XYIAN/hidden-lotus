  ...
  return (
    <div className="flex flex-column align-items-center justify-content-center min-h-screen p-4 text-center">
      <div className="max-w-md mx-auto">
        ...
        <h2 className="text-2xl font-semibold text-sage-green-800 mb-3">Page Not Found</h2>
        ...
        <div className="mt-8 p-4 bg-light-tan/50 rounded-lg">
          <h3 className="text-lg font-semibold text-primary-green mb-3">Popular Pages</h3>
