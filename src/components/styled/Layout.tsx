...
import { commonStyles } from '@/lib/styled-components'
    ...
    if (typeof columns === 'number') {
      ...
      return css`
        ...
        @media (min-width: 768px) {
          grid-template-columns: repeat(${columns.tablet || columns.mobile || 2}, 1fr);
        }

        @media (min-width: 1024px) {
          grid-template-columns: repeat(${columns.desktop || columns.tablet || columns.mobile || 3}, 1fr);
        }
      `
    }
  }}
