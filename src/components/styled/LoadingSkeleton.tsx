...
export const LoadingSkeleton = ({
	...
	const renderSkeleton = () => {
		switch (type) {
				...
				return (
					<div className={className}>
						{Array.from({ length: count }).map((_, index) => (
							<TextSkeleton key={index} width={width} height={height} />
						))}
					</div>
				)
			...
			case 'button':
				return (
					<ButtonSkeleton className={className} width={width} height={height} />
				)

			case 'title':
				return (
					<TitleSkeleton className={className} width={width} height={height} />
				)

			default:
				return (
					<SkeletonBase className={className} width={width} height={height} />
				)
		}
	}
