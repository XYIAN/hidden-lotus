...
export function StoryGrid({ stories, onStoryClick, clearFilters }: StoryGridProps) {
  if (stories.length === 0) {
    return (
      <Card className="yoga-card p-8 text-center">
        <div className="text-6xl mb-4">😔</div>
        <h3 className="text-xl font-semibold text-primary-green mb-2">No Stories Found</h3>
        <p className="text-earth-brown mb-4">
          Try adjusting your search criteria or filters to find inspiring stories.
        </p>
        {clearFilters && (
          <Button
