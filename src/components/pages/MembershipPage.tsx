...
const MembershipPageContent = memo(function MembershipPageContent() {
	return (
		<MembershipContainer>
			<Stack spacing="xl">
				{/* Hero Section */}
											...
											<div>
												...
												<FeatureList>
													<FeatureItem>
														...
														<span>
															Unlimited access to all yoga and meditation
															classes
														</span>
													</FeatureItem>
													<FeatureItem>
								...
								<Section>
									<Stack spacing="lg" align="center">
										<div>
											...
											>
												One comprehensive membership plan designed to support
