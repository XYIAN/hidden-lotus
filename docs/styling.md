...
.lotus-title-fancy {
  background: linear-gradient(135deg, var(--primary-green), var(--sage-green-600));
...
.bg-brown-gold { background-color: var(--brown-gold); }
...
.text-brown-gold { color: var(--brown-gold); }
...
### Border Utilities
```css
.sage-border { border-color: var(--sage-green-200); }
.border-sage-green-200 { border-color: var(--sage-green-200); }
.border-sage-green-400 { border-color: var(--sage-green-400); }
.border-sage-green-600 { border-color: var(--sage-green-600); }
...
```css
.soft-rounded { border-radius: 12px; }
.soft-rounded-sm { border-radius: 8px; }
.soft-rounded-lg { border-radius: 16px; }
```
...
```css
/* Efficient selectors */
.yoga-card { /* Single class selector */ }
.yoga-card:hover { /* Pseudo-class */ }
.yoga-card .p-card-body { /* Descendant selector */ }
...
.text-primary-green { /* High contrast on light backgrounds */ }
.text-earth-brown { /* Readable secondary text */ }
.bg-sage-green-600 { /* Sufficient contrast for text */ }
```
...
*This styling system provides a comprehensive, maintainable, and performant approach to styling the Hidden Lotus wellness platform while maintaining consistency and accessibility.*
